...
function CategoryBanner() {
  ...
  return (
   ...
   <section className='bg-black flex '>
    ...
    <div className=' relative flex flex-col text-white justify-center items-center w-full bg-cover h-[32rem] object-cover bg-no-repeat  bg-[url("https://images.pexels.com/photos/4046986/pexels-photo-4046986.jpeg?auto=compress&cs=tinysrgb&w=1200&lazy=load")]'>
