...
function ProductCard({item}) {
  ...
  return (
    <div className='rounded  cursor-move shadow md:shadow-md lg:shadow-lg' id={item._id}  key={item._id} >
        <img src={item.image} alt="hero-img"  className=' w-full h-full object-cover'/>
